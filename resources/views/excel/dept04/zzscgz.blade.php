        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <div class="list-group">
                    ...
                    <a href="/excel/dept04/zzscgz" class="list-group-item active">月度生产跟踪报表</a>
                </div>
            </div>

            <div class="col-md-10">
                <iframe src="http://10.48.21.23:8080/demo/reportJsp/showReport.jsp?rpx=/dept04/zzscgz.rpx"
